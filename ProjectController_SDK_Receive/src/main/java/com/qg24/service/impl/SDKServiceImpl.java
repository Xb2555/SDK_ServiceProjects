...
public class SDKServiceImpl implements SDKService {
    ...
    public void batchInsertBackendExceptionInfo(List<BackendExceptionInfoDTO> backendExceptionInfoDTOList) throws Exception {
        ...
        projectService.updateBackendErrorNum(backendExceptionInfoDTOList.size(), Integer.parseInt(backendExceptionInfoDTOList.get(0).getProjectId()));
    ...
    public void batchInsertBackendLog(List<BackendLogDTO> backendLogDTOList) throws Exception {
        ...
        projectService.updateErrorRate(backendLogDTOList.size(), Integer.parseInt(backendLogDTOList.get(0).getProjectId()));
